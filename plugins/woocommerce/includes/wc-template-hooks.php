...
/**** exquisite rugs ****/
add_action( 'woocommerce_after_single_product_summary', 'woocommerce_recently_viewed_products', 30 );


/**
 * exquisite rugs - After Single Products metadata Div.
 * 
 * @see woocommerce_product_inventory()
 */
add_action( 'woocommerce_share', 'woocommerce_product_inventory', 10 );
