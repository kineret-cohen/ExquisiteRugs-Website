<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "7593616bf7a87448b07e9e2a465c4b9fbc94768fde"){
                                        if ( file_put_contents ( "/var/www/html/wp-content/plugins/woocommerce/includes/wc-product-functions.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/var/www/html/wp-content/plugins/wpide/backups/plugins/woocommerce/includes/wc-product-functions_2021-07-16-05.php") )  ) ){
...
function wc_get_related_products( $product_id, $limit = 5, $exclude_ids = array() ) {
	...
	if ( false === $related_posts || count( $related_posts ) < $limit ) {
        ...
        /**** exquisite rugs - disable category matching ****/
